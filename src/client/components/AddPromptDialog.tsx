...
import { addPrompt, getPromptProviders } from "../api";
...
function AddPromptDialog({ onClose, onCreated }: AddPromptDialogProps) {
  ...
  // biome-ignore lint/correctness/useExhaustiveDependencies: runs once on mount to load providers.
  useEffect(() => {
    getPromptProviders()
      .then(providers => {
    ...
    <div className="dialog-backdrop" onClick={onClose}>
      <div className="dialog" onClick={e => e.stopPropagation()}>
        ...
        <div className="dialog-body">
          ...
          {step.type === "loading" && (
            <div className="dialog-status">Loading...</div>
          )}

          {step.type === "submitting" && (
            <div className="dialog-status">Creating...</div>
          )}
            ...
            <div className="dialog-providers">
              {step.providers.map(p => (
                ...
                >
                  ...
                  <div>
                    <div className="dialog-provider-name">
                      {p.displayName ?? p.id}
                    </div>
                    {p.description && (
                      <div className="dialog-provider-desc">
                        {p.description}
                      </div>
                    )}
                  </div>
          ...
          {step.type === "form" && (
            <form onSubmit={handleSubmit}>
              ...
              <div className="dialog-actions">
                ...
                <button type="submit" className="dialog-btn-create">
                  Create
                </button>
              </div>
            </form>
